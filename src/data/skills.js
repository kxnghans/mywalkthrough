export const skillsData = [
  {
    ...
    details: [
      ...
      { name: "SQL", priority: 2 },
      { name: "HTML", priority: 2 },
      { name: "CSS", priority: 2 },
      { name: "JavaScript", priority: 1 },
      { name: "PHP", priority: 3 },
      { name: "VueJS", priority: 2 },
      { name: "Ansible", priority: 3 },
      { name: "C", priority: 3 },
      { name: "C++", priority: 2 },
      { name: "YAML", priority: 3 },
      { name: "Markdown", priority: 4 },
    ],
    exposure: ["Verilog", "Assembly Language", "JQuery", "C#", "Java"],
    modalDetails: {
      title: "Programming Skills",
      subtitle: "Languages, Frameworks, and Tools",
      details: [
        "Python, JavaScript, C++, PHP, C, C++",
        "Keras, SQL, HTML, CSS, VueJS, Ansible, YAML, Markdown",
      ],
      exposure: ["Verilog, Assembly Language", "JQuery", "C#", "Java"],
    },
  },
  {
    ...
    modalDetails: {
      ...
      subtitle: "Data-driven Insights and Solutions",
      details: [
        ...
        "Regression Analysis, Statistical Modeling, Data Visualization, Data Pipeline Automation",
      ],
    },
  },
  {
    ...
    details: [
      ...
      { name: "OpenShift", priority: 2 },
      { name: "Kubernetes", priority: 2 },
      { name: "Docker", priority: 2 },
      { name: "Podman", priority: 3 },
      { name: "Git", priority: 1 },
      { name: "Jira", priority: 2 },
      { name: "Azure DevOps (ADO)", priority: 2 },
  ...
  },
  {
    ...
    details: [
      ...
      { name: "Model Based Systems Engineering", priority: 2 },
      { name: "Stakeholder Management", priority: 2 },
      { name: "Requirements Gathering", priority: 2 },
      { name: "Business Analysis", priority: 2 },
      { name: "UI/UX Design (Adobe XD)", priority: 3 },
    ],
    modalDetails: {
      title: "Project & Program Management Skills",
      subtitle: "Leading and Delivering Successful Initiatives",
      details: [
