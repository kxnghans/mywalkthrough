        ...
        <div className="p-6">
          ...
          <div className="mt-6 flex space-x-4">
            <a
              ...
              className="bevel-button-dark flex items-center space-x-2 transform rounded-lg bg-red-600 px-4 py-2 font-bold text-white transition-all duration-200 hover:bg-red-700"
            >
              <FaCirclePlay />
              <span>Demo</span>
            </a>
