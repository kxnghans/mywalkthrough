...
const CommunitySlideshow = () => {
    ...
    return (
        <Section title="Community Involvement" className="flex-1 flex flex-col min-h-0 !p-0 sm:!p-2 md:!p-4">
            <div className="relative flex-1 flex items-center">
                ...
                <div ref={slideshowRef} className="flex overflow-x-auto snap-x snap-mandatory space-x-4 pb-4 scrollbar-hide h-full items-center">
