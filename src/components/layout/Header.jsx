    ...
    useEffect(() => {
        ...
        if (SpeechRecognition) {
            ...
            recognition.onerror = (event) => {
                ...
                setPlaceholderText('Search error. Try again.');
                setIsMicActive(false);
            };
    ...
    const toggleMic = () => {
        if (recognitionRef.current) {
            if (!isMicActive) {
                ...
                // Stop the recognition if it's already active
            ...
            <div className="flex-1 max-w-xl mx-4 hidden md:flex items-center">
                <div className="relative w-full">
                    <input
                        ...
                        className="w-full bg-gray-200 dark:bg-black rounded-full py-2 pl-10 pr-4 focus:ring-2 focus:ring-red-500 focus:outline-none bevel-light-inset dark:bevel-dark-inset"
                    />
