            ...
            <div className="flex flex-col md:flex-row md:space-x-12">
                ...
                <div className="flex-1 mt-8 md:mt-0">
                    <form className="space-y-4">
                        ...
                        <button type="submit" className="w-full text-gray-800 dark:text-gray-300 font-bold py-3 px-4 rounded-lg transition-all duration-200 transform hover:opacity-80 active:scale-95 bevel-light dark:neumorphic-outset-dark inline-flex items-center justify-center">Send Message <FaPaperPlane className="ml-2" /></button>
                    </form>
                </div>
            </div>
        </Section>
